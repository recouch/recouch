...
describe('Blob', () => {
  ...
  describe('databaseGetBlob/databaseSaveBlob', () => {
    it('saves and retrieves a blob not belonging to a document', () => {
      ...
      expect(() => databaseSaveBlob(db, blob)).not.toThrow()
  ...
  describe('write stream', () => {
    it('creates a blob in pieces', () => {
      ...
      expect(() => writeBlobWriter(stream, Buffer.from('three '))).not.toThrow()
      expect(() => writeBlobWriter(stream, Buffer.from('easy '))).not.toThrow()
      expect(() => writeBlobWriter(stream, Buffer.from('pieces'))).not.toThrow()
