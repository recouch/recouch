...
// Stolen from https://raw.githubusercontent.com/TomokiMiyauci/curry/main/curry.ts
 ...
 * @internal
 */
export type Curried<Args extends AnyArray, ReturnValue> = Args extends [] ? ReturnValue
  : Union2Intersection<
